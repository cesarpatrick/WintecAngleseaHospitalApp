...
public class ListNotificationsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbarListNotifications);
        ...
        RecyclerView mRecyclerView = findViewById(R.id.notificationsRecyclerView);
        mRecyclerView.setHasFixedSize(true);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(this);
        RecyclerView.Adapter mAdapter = new NotificationAdapter(this, new ArrayList<>(dbHelper.getAllNotifications()));
